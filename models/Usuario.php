<?php
    class Usuario extends Conectar{
            ...
            if(isset($_POST["enviar"])){
                ...
                if(empty($correo) and empty($pass)){
                    ...
                    if (is_array($resultado) and count($resultado)>0){
                        ...
                        $_SESSION["asignar"]=$resultado["asignar"];
        ...
        public function insert_usuario($usu_nom,$usu_ape,$usu_correo,$usu_pass,$rol_id, $asignar){

            $conectar= parent::conexion();
            parent::set_names();
            $sql="INSERT INTO tm_usuario (usu_id, usu_nom, usu_ape, usu_correo, usu_pass, rol_id, fech_crea, fech_modi, fech_elim, est,asignar) VALUES (NULL,?,?,?,md5(?),?,now(), NULL, NULL, '1',?);";
            ...
            $sql->bindValue(6, $asignar);
            $sql->execute();
            return $resultado=$sql->fetchAll();
        }

        public function update_usuario($usu_id,$usu_nom,$usu_ape,$usu_correo,$usu_pass,$rol_id, $asignar){
