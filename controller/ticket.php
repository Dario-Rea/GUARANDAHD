<?php
    ...
    switch($_GET["op"]){
        ...
        case "insert":
            $datos=$ticket->insert_ticket($_POST["usu_id"],$_POST["cat_id"],$_POST["tick_prioridad"],$_POST["tick_titulo"],$_POST["tick_descrip"]);
                ...
                foreach($datos as $row){
                 ...
                 if($_FILES['files']['name']==0){
                        ...
                        for ($i= 0; $i < $countfiles ; $i++ ){
                            ...
                            $documento->insert_documento( $output["tick_id"], $_FILES['files']['name'][$i]);
